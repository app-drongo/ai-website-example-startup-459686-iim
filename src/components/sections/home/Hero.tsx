...
const DEFAULT_HERO = {
  badge: 'New: Launch in 24 Hours',
  title: "Build your startup's first",
  titleHighlight: 'high-converting landing page',
  description:
    'Skip the complexity. Get a professional, conversion-optimized landing page that turns visitors into customers. Perfect for tech startups ready to validate and scale.',
  features: [
  ...
  imageAlt: 'Startup dashboard analytics',
