...
const DEFAULT_FOOTER = {
  logoText: 'Example Startup',
  companyDescription:
    'Revolutionizing the startup ecosystem with innovative solutions and cutting-edge technology. Join thousands of entrepreneurs and investors who trust our platform to accelerate growth and drive success.',
  contactEmail: 'hello@examplestartup.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Innovation Drive, Tech Hub 200',
  newsletterTitle: 'Stay Ahead',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer:
    'Get exclusive startup insights and funding opportunities. No spam, unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Example Startup. All rights reserved.',
  madeWithText: 'by our passionate team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/examplestartup',
  social2Href: 'https://facebook.com/examplestartup',
  social3Href: 'https://instagram.com/examplestartup',
  social4Href: 'https://linkedin.com/company/examplestartup',
  social5Href: 'https://github.com/examplestartup',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Startup Tools', href: '/tools', editableId: 'link-footer-tools' },
        { name: 'Funding Hub', href: '/funding', editableId: 'link-footer-funding' },
        { name: 'Pitch Deck Builder', href: '/pitch-builder', editableId: 'link-footer-pitch' },
        { name: 'Investor Network', href: '/investors', editableId: 'link-footer-investors' },
        { name: 'Analytics', href: '/analytics', editableId: 'link-footer-analytics' },
        { name: 'Marketplace', href: '/marketplace', editableId: 'link-footer-marketplace' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Success Stories', href: '/success-stories', editableId: 'link-footer-stories' },
    ...
    },
    {
      ...
      links: [
        { name: 'Startup Guide', href: '/guide', editableId: 'link-footer-guide' },
        ...
        { name: 'Mentor Network', href: '/mentors', editableId: 'link-footer-mentors' },
        { name: 'Resource Library', href: '/resources', editableId: 'link-footer-resources' },
